...
- **Evidence/blockers:** macOS Darwin 24.3.0 / Node v24.15.0 passed focused F1–F5 tests, typecheck, 234 deterministic tests, high-severity npm audit, and diff check. Independent audit and real Linux Node 24 operational evidence are pending; Linux Bubblewrap requires upstream 0.12.0+ or trusted CVE-2026-87766 backport evidence, plus a passing adversarial probe. The pinned dependency tree has 16 moderate and 6 low audit advisories.
